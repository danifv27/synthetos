...
type SecretCmd struct {
	Flags SecretFlags `embed:""`
}

type SecretFlags struct {
}

func initializeSecretCmd(ctx floc.Context, ctrl floc.Control) error {

	return nil
}

func (cmd *SecretCmd) Run(cli *CLI, c *common.Cmdctx, rcerror *error) error {
	...
	c.InitSeq = append(c.InitSeq, initializeSecretCmd)
